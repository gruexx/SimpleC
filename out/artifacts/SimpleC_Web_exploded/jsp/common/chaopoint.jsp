    ...
    <div class="am-offcanvas-bar am-offcanvas-bar-flip">
        <div class="am-offcanvas-content">
            ...
            <div class="award" style="height:55%;font-size: 15px;color: #ab2e2b">积分抽奖<br>
                <div style="height: 90%;">
                    <table>
                        <tr><img src="${APP_PATH}/GoodsImage/tan90.jpg" class="am-img-responsive" /></tr>
                        <tr><img src="${APP_PATH}/GoodsImage/tan90.jpg" class="am-img-responsive" style="height: 100px;width: auto;"/></tr>
                        <tr><img src="${APP_PATH}/GoodsImage/tan90.jpg" class="am-img-responsive" style="height: 100px;width: auto;"/></tr>
                    </table>
